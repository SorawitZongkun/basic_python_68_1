...
print(this_tuple)
print(this_tuple[1])  # Accessing the second item
print(type(this_tuple))  # Checking the type
print(len(this_tuple))  # Length of the tuple
...
print(this_dict)
print(this_dict["model"])  # Accessing the value for key 'model'
print(type(this_dict))  # Checking the type
print(len(this_dict))  # Length of the dictionary